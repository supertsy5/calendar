...
translate!(
    ...
    (TitleColor, "Title Color", "标题颜色", "標題顏色"),
    ...
    (WeekdaySize, "Weekday Text Size", "星期字号", "星期字號"),
    (ChineseSize, "Chinese Date Text Size", "农历字号", "農曆字號"),
    (MonthSize, "Month Text Size", "月字号", "月字號"),
    (YearSize, "Year Text Size", "年字号", "年字號"),
